    ...
    <div class="left">
        ...
        <div class="pagination">
            <c:choose>
                ...
                <c:otherwise>
                    <a href="index.do?PageBegin=1">首页</a>
                    <a href="index.do?PageBefore=1">上一页</a>
                </c:otherwise>
            </c:choose>
            <c:forEach var="i" begin="1" end="${PageNum.PageTotal}" step="1">
                <c:choose>
                    <c:when test="${i==PageNum.PageNow}">
                        <a href="index.do?PageNow=${i}" class="current">${i}</a>
                    </c:when>
                    <c:otherwise>
                        <a href="index.do?PageNow=${i}">${i}</a>
                    </c:otherwise>
                </c:choose>
            </c:forEach>
            <c:choose>
                ...
                <c:otherwise>
                    <a href="index.do?PageLast=1">下一页</a>
                    <a href="index.do?PageEnd=1">尾页</a>
                </c:otherwise>
            </c:choose>
        </div>
            ...
            <div class="Link">
                ...
                <c:choose>
                    <c:when test="${user==null}">
                        <div>用户您好！请先登录！</div>
                        <a href="jsp/Login.jsp?page=index">登录</a>
                        <a href="jsp/register.jsp?page=life?page=index">注册</a>
                    </c:when>
                    <c:otherwise>
