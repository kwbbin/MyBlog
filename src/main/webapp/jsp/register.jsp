...
<body>
    <div class="bodyBox">
        <div class="registerBox">
            <div class="left">
                <div id="lTop" class="lTop"><span>登<br>陆</span></div>
                <div id="lBottom" class="lBottom action"><span>注<br>册</span></div>
            </div>
            <div id="right1" class="right1" style="display:none">
                <div class="form">
            ...
            <div id="right2" class="right2" style="display:block">
                <div class="form">
