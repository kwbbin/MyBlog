    ...
    <div class="left">
        ...
        <div class="pagination">
            <c:choose>
                ...
                <c:otherwise>
                    <a href="life.do?PageBegin=1">首页</a>
                    <a href="life.do?PageBefore=1">上一页</a>
                </c:otherwise>
            </c:choose>
            <c:forEach var="i" begin="1" end="${PageNum.PageTotal}" step="1">
                <c:choose>
                    <c:when test="${i==PageNum.PageNow}">
                        <a href="life.do?PageNow=${i}" class="current">${i}</a>
                    </c:when>
                    <c:otherwise>
                        <a href="life.do?PageNow=${i}">${i}</a>
                    </c:otherwise>
                </c:choose>
            </c:forEach>
            <c:choose>
                ...
                <c:otherwise>
                    <a href="life.do?PageLast=1">下一页</a>
                    <a href="life.do?PageEnd=1">尾页</a>
                </c:otherwise>
            </c:choose>
        </div>
            ...
            <div class="Link">
                ...
                <c:choose>
                    <c:when test="${user==null}">
                        <div>用户您好！请先登录！</div>
                        <a href="jsp/Login.jsp?page=life">登录</a>
                        <a href="jsp/register.jsp?page=life">注册</a>
                    </c:when>
                    <c:otherwise>
